...
class _DerivedDim(_Dim):
    ...
    This restriction on the form of derived Dims makes the metatheory
    simpler: e.g., it simplifies solving for the underlying regular Dims, deciding
    equalities between derived Dims, and so on.
